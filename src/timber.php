<?php
/*
Plugin Name: Timber (MODIFIED | willpercey-gb)
Description: The WordPress Timber Library allows you to write themes using the power Twig templates. (THIS PLUGIN HAS BEEN MODIFIED DO NOT UPDATE)
Plugin URI: http://timber.upstatement.com
Author: Jared Novack + Upstatement
Version: 0.22.1
Author URI: https://thedesignlab.net/
*/
